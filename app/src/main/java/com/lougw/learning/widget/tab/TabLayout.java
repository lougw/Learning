        ...
        public void draw(Canvas canvas) {
            ...
            if (mIndicatorLeft >= 0 && mIndicatorRight > mIndicatorLeft) {
                ...
                if (mSelectedIndicatorWidth > 0 && getSelectedTabPosition() >= 0 &&
                    ...
                    mLeft = mIndicatorLeft + (getChildAt(getSelectedTabPosition()).getMeasuredWidth() - mSelectedIndicatorWidth) / 2.0f;
                    mRight = mLeft + mSelectedIndicatorWidth;
                    canvas.drawRect(mLeft, getHeight() - mSelectedIndicatorHeight,
                            mRight, getHeight(), mSelectedIndicatorPaint);
                } else {
